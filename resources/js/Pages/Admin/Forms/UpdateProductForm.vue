<template>
    <form @submit.prevent="submit">
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit" :disabled="formData.processing" :class="{'bg-primary/10': formData.processing}" class="rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary/50">Update</button>
        </div>
    </form>
</template>
