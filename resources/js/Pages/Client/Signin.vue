<template>
    <Head title="Sign in" />
    <div class="flex-1 flex flex-col justify-center py-32 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div class="mx-auto w-full max-w-sm lg:w-96">
            <div>
                <div class="flex items-center">
                    <img class="h-16 w-auto" :src="MedenaLogo" alt="Workflow" />
                    <div>
                        <h1 class="text-2xl font-medium text-primary">MedenaROSE</h1>
                        <p class="text-sm">Quality you can see.</p>
                    </div>
                </div>
...
<!--                        </div>-->
                        ...
                        <div>
                            <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary/50">Sign in</button>
                        </div>
                    </form>
                    <p class="text-md mt-3 text-center capitalize">Don't Have an account yet? create one <Link href="/signup" class="text-primary underline decoration-dashed">Sign up</Link></p>
                </div>
            </div>
        </div>
    </div>
...
import MedenaLogo from "../../../assets/pink-logo.svg";
